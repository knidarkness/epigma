...
const Header = ({zoom, changeZoom, undo, redo, enableViewMode, enableDrawMode, editorMode, enableDeleteMode}) => (
    <header className="toolbar">
        ...
        <section className="toolbar__items">
            ...
            <button className="toolbar__button toolbar__button_zoom-in"  onClick={() => changeZoom(0.01)}/>
            <button className="toolbar__button toolbar__button_zoom-out"  onClick={() => changeZoom(-0.01)}/>
