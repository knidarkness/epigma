    ...
    it('Creates DOCUMENT_FETCH_SUCCESS when documents have been successfully fetched', () => {
        fetchMock
            .getOnce(DOCUMENT_LIST_URI, { 
                status: 200,
                body: {documents: [
                    {id: '1', name: 'document 1', editedAt: '1523109000'}
                ]}
            });
  
        const expectedActions = [
            documentsActions.fetchDocumentsSuccess([
                {id: '1', name: 'document 1', editedAt: '1523109000'}
            ])
        ];
        const store = mockStore({});
...
describe('Documents reducers tests', () => {
    ...
    it('Create document for non-empty state', () => {
        ...
        const expected = [
            { id: '2', name: 'document 2', editedAt: '1523109001'}, { id: '1', name: 'document 1', editedAt: '1523109000' }
        ];
        assert.deepEqual(actual, expected);
    });
    ...
    it('Store data after fetching documents', () => {
        ...
        const actual = reducer(state, documentsActions.fetchDocumentsSuccess([
            { id: '2', name: 'document 2', editedAt: '1523109001'}
        ]));
        const expected = [
            { id: '2', name: 'document 2', editedAt: '1523109001'}
        ];
    ...
    it('Delete document from non-empty state', () => {
        const state = [
            { id: '1', name: 'document 1', editedAt: '1523109000' }, { id: '2', name: 'document 2', editedAt: '1523109001'}
        ];
    ...
    it('Rename document in not-empty state', () => {
        ...
        const expected = [
            { id: '2', name: 'new name', editedAt: '1523109002'}, { id: '1', name: 'document 1', editedAt: '1523109000' }
        ];
        assert.deepEqual(actual, expected);
    });
